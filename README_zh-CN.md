...
## 最新动态
- 🔥 2025-12-22：我们升级了 [OpenDataArena]，支持 Qwen3-VL 多模态数据价值评估及 79 项评分维度。
...
3. **多维数据评分**
  ...
  * **丰富的指标库**：支持 79 个评分维度，用户只需一键即可生成全面的数据质量报告。
...
ODA 已覆盖 **4+ 个领域**、**20+ 个基准测试**、**79 个评分维度**，处理了 **120+ 个数据集**，评估了 **4000 万+ 个样本**，完成了 **600+ 次训练运行** 和 **1 万+ 次评测** —— 各项指标仍在持续增长中。

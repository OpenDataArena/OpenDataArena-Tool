...
* [Model-based Evaluation](model-based-evaluation)
    ...
    * [ComplexityScorer](model-based-evaluation#complexityscorer)
    ...
    * [EmbedSVDEntropyScorer](model-based-evaluation#embedsvdentropyscorer)
    ...
    * [SkyworkLlamaScorer](model-based-evaluation#skyworkllamascorer)
    * [SkyworkQwenScorer](model-based-evaluation#skyworkqwenscorer)
...
* [Heuristic](heuristic)
    ...
    * [CompressRatioScorer](heuristic#compressratioscorer)
    ...
    * [LogicalWordCountScorer](heuristic#logicalwordcountscorer)

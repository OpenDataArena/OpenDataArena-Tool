...
Common embedding models that can be used include:
- **Sentence Transformers**: `sentence-transformers/all-mpnet-base-v2`, `sentence-transformers/all-MiniLM-L6-v2`
- **BGE series**: `BAAI/bge-large-en-v1.5`, `BAAI/bge-base-en-v1.5`
- **E5 series**: `intfloat/e5-large-v2`, `intfloat/multilingual-e5-large`
- **OpenAI embeddings**: `text-embedding-ada-002`, `text-embedding-3-large`
- **Custom domain-specific models**: Any embedding model suitable for your data domain

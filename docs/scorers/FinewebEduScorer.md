...
| `model` | string | `"HuggingFaceTB/fineweb-edu-classifier"` | Path to the model checkpoint or Hugging Face model identifier. Can specify a local model path if you have a fine-tuned version |

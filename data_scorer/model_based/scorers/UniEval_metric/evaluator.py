...
class SumEvaluator:
    def __init__(self, max_length=1024, device='cuda:0', cache_dir=None, model_name_or_path='MingZhong/unieval-sum', local_files_only=False):
...
class DialogEvaluator:
    def __init__(self, max_length=1024, device='cuda:0', cache_dir=None, model_name_or_path='MingZhong/unieval-dialog', local_files_only=False):
...
class FactEvaluator:
    def __init__(self, max_length=1024, device='cuda:0', cache_dir=None, model_name_or_path='MingZhong/unieval-fact', local_files_only=False):

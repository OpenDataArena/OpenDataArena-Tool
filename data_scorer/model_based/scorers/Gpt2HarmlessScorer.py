...
class Gpt2HarmlessScorer(BaseScorer):
    """
    GPT2-based harmlessness reward model scorer
    using Ray2333/gpt2-large-harmless-reward_model.
    """

    DEFAULT_MODEL = "Ray2333/gpt2-large-harmless-reward_model"
    ...
    def _setup(self):
        ...
        print("✅ Gpt2HarmlessScorer setup complete.")
    ...
    def evaluate(self, dataset) -> List[Dict]:
        ...
        with open(dataset, "r", encoding="utf-8") as f:
            pbar = tqdm(total=num_lines, desc="Gpt2HarmlessScorer")
            for line in f:
